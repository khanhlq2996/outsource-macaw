...
if ( isset( $_GET['action'] ) ) {
	/** This action is documented in acp/network/edit.php */
		...
		case 'allusers':
			...
			if ( ( isset( $_POST['action'] ) || isset( $_POST['action2'] ) ) && isset( $_POST['allusers'] ) ) {
				...
				if ( ! in_array( $doaction, array( 'delete', 'spam', 'notspam' ), true ) ) {
					...
					/** This action is documented in acp/network/site-themes.php */
...
<?php require_once(ABSPATH . 'acp/admin-footer.php'); ?>
