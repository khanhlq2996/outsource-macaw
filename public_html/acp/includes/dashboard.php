...
function wp_dashboard_setup() {
	...
	if ( 'POST' == $_SERVER['REQUEST_METHOD'] && isset( $_POST['widget_id'] ) ) {
		...
		ob_start(); // hack - but the same hack acp/widgets.php uses
	...
	/** This action is documented in acp/includes/meta-boxes.php */
 ...
 * which is later replaced by Ajax call (see top of /acp/index.php)
 *
 * @since 2.5.0
 *
 * @param string $widget_id
