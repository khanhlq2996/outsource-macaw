		...
		if ( is_multisite() && get_site_option( 'ms_files_rewriting' ) ) {
			...
			$web_config_file .= '
                <rule name="WordPress Rule 2" stopProcessing="true">
                    <match url="^' . $iis_subdir_match . 'acp$" ignoreCase="false" />
                    <action type="Redirect" url="' . $iis_subdir_replacement . 'acp/" redirectType="Permanent" />
                </rule>
...
{$ms_files_rewriting}
# add a trailing slash to /acp
RewriteRule ^{$subdir_match}acp$ {$subdir_replacement_01}acp/ [R=301,L]
