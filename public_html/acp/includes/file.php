...
function _unzip_file_pclzip( $file, $to, $needed_dirs = array() ) {
	...
	require_once(ABSPATH . 'acp/includes/class-pclzip.php');
...
function WP_Filesystem( $args = false, $context = false, $allow_relaxed_file_ownership = false ) {
	...
	require_once(ABSPATH . 'acp/includes/class-wp-filesystem-base.php');
	...
	if ( ! class_exists( "WP_Filesystem_$method" ) ) {
		 ...
		 */
		$abstraction_file = apply_filters( 'filesystem_method_file', ABSPATH . 'acp/includes/class-wp-filesystem-' . $method . '.php', $method );
...
function wp_privacy_process_personal_data_export_page( $response, $exporter_index, $email_address, $page, $request_id, $send_as_email, $exporter_key ) {
	...
	/** This filter is documented in acp/includes/ajax-actions.php */
