...
require_once(ABSPATH . 'acp/includes/class-walker-category-checklist.php');

/** WP_Internal_Pointers class */
require_once(ABSPATH . 'acp/includes/class-wp-internal-pointers.php');
...
function get_inline_data( $post ) {
	...
	/** This filter is documented in acp/edit-tag-form.php */
	echo '
...
var ajaxurl = '<?php echo admin_url( 'admin-ajax.php', 'relative' ); ?>',
	...
	<?php
	/** This action is documented in acp/admin-header.php */
	...
	<?php
	/** This filter is documented in acp/admin-header.php */
...
function iframe_footer() {
	...
	<div class="hidden">
	<?php
	/** This action is documented in acp/admin-footer.php */
...
<html xmlns="http://www.w3.org/1999/xhtml" class="<?php echo $admin_html_class; ?>"
	<?php
	/** This action is documented in acp/includes/template.php */
	do_action( 'admin_xml_ns' );
