...
function wp_ajax_imgedit_preview() {
	...
	include_once(ABSPATH . 'acp/includes/image-edit.php');
...
function wp_ajax_autocomplete_user() {
	...
	/** This filter is documented in acp/user-new.php */
...
function wp_ajax_add_menu_item() {
	...
	require_once ABSPATH . 'acp/includes/nav-menu.php';
	...
	/** This filter is documented in acp/includes/nav-menu.php */
...
function wp_ajax_inline_save() {
	...
	if ( ! empty( $data['tax_input'] ) ) {
		foreach ( $data['tax_input'] as $taxonomy => $terms ) {
			...
			/** This filter is documented in acp/includes/class-wp-posts-list-table.php */
...
function wp_ajax_save_widget() {
	...
	/** This action is documented in acp/widgets.php */
...
function wp_ajax_delete_inactive_widgets() {
	...
	/** This action is documented in acp/includes/ajax-actions.php */
	do_action( 'load-widgets.php' );
	/** This action is documented in acp/includes/ajax-actions.php */
	do_action( 'widgets.php' );
	/** This action is documented in acp/widgets.php */
...
function wp_ajax_get_revision_diffs() {
	require ABSPATH . 'acp/includes/revision.php';
...
function wp_ajax_query_themes() {
	...
	/** This filter is documented in acp/includes/class-wp-theme-install-list-table.php */
...
function wp_ajax_crop_image() {
	...
	switch ( $context ) {
		case 'site-icon':
			...
			/** This filter is documented in acp/custom-header.php */
...
function wp_ajax_install_theme() {
	...
	include_once(ABSPATH . 'acp/includes/class-wp-upgrader.php');
	include_once(ABSPATH . 'acp/includes/theme.php');
...
function wp_ajax_install_plugin() {
	...
	include_once(ABSPATH . 'acp/includes/class-wp-upgrader.php');
	include_once(ABSPATH . 'acp/includes/plugin-install.php');
