...
?>
    <link rel="stylesheet" href="/acp/css/custom.css" type="text/css" media="all">
</head>
<?php
/**
 ...
 * 2. Not all core admin classes are filterable, notably: acp, wp-core-ui,
...
<div id="wpwrap">
<?php require(ABSPATH . 'acp/menu-header.php'); ?>
<div id="wpcontent">
...
if ( $parent_file == 'options-general.php' ) {
	require(ABSPATH . 'acp/options-head.php');
}
