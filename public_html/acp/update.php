...
if ( isset( $_GET['action'] ) ) {
	...
	if ( 'update-selected' == $action ) {
		...
		include_once(ABSPATH . 'acp/includes/plugin-install.php'); //for plugins_api..
		...
		include_once(ABSPATH . 'acp/includes/class-wp-upgrader.php'); //for themes_api..
		 ...
		 * provided in the request for acp/update.php. Can be used to
