		...
		*/
		...
		<div id="shop-sidebar" class="mfp-hide">
			<div class="sidebar-inner">
				<?php
				  $no_widgets_msg = '<p>You need to assign Widgets to <strong>"Shop Sidebar"</strong> in <a href="'.get_site_url().'/acp/widgets.php">Appearance > Widgets</a> to show anything here</p>';
