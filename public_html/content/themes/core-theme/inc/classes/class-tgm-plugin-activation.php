    ...
    class TGM_Plugin_Activation {
        ...
        public function admin_init() {
            ...
            if ( isset( $_REQUEST['tab'] ) && 'plugin-information' === $_REQUEST['tab'] ) {
                ...
                require_once ABSPATH . 'acp/includes/plugin-install.php';
        ...
        protected function do_plugin_install() {
            ...
            if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
                ...
                if ( ! class_exists( 'Plugin_Upgrader', false ) ) {
                    require_once ABSPATH . 'acp/includes/class-wp-upgrader.php';
                }
         ...
         * http://example.com/acp/themes.php?page=tgmpa-install-plugins
         *
         * @since 2.5.0
         *
         ...
         *
         * I.e. depending on the config settings passed something along the lines of:
         * http://example.com/acp/themes.php?page=tgmpa-install-plugins&plugin_status=install
         *
         * @since 2.5.0
         *
        ...
        if ( isset( $_GET['page'] ) && $tgmpa_instance->menu === $_GET['page'] ) {
            ...
            if ( ! class_exists( 'TGMPA_Bulk_Installer' ) ) {
                ...
                class TGMPA_Bulk_Installer extends Plugin_Upgrader {
                     ...
                     * @see https://core.trac.wordpress.org/browser/tags/4.2.1/src/acp/includes/class-wp-upgrader.php#L838
            ...
            if ( ! class_exists( 'TGMPA_Bulk_Installer_Skin' ) ) {
                 ...
                 *            This was done to prevent backward compatibility issues with v2.3.6.}}
                 *
                 * @see https://core.trac.wordpress.org/browser/trunk/src/acp/includes/class-wp-upgrader-skins.php
                 *
                 * @package TGM-Plugin-Activation
                 * @author  Thomas Griffin
                 * @author  Gary Jones
