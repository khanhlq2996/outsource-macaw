...
class Flatsome_Admin {
	...
	public function flatsome_panel_register_menu() {
		...
		add_menu_page( 'Welcome to Config', 'Cấu hình Theme', 'manage_options', 'flatsome-panel', array( $this, 'flatsome_panel_welcome' ), get_template_directory_uri().'/assets/img/logo-icon.svg', '2');
