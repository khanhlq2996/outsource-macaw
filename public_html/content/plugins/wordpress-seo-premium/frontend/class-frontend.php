...
class WPSEO_Frontend {
	...
	public function get_debug_mark() {
		return sprintf(
			...
			/**
			 * Filter: 'wpseo_hide_version' - can be used to hide the Yoast SEO version in the debug marker (only available in SEO Tool Premium).
			 *
			 * @api bool
			 */
	...
	private function head_product_name() {
		if ( $this->is_premium() ) {
			return 'SEO Tool Premium plugin';
		}
