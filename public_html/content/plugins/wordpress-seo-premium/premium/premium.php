...
class WPSEO_Premium {
	...
	/**
	 * Sets up the SEO Tool Premium plugin.
	 *
	 * @return void
	 */
	...
	public function redirect_canonical_fix( $redirect_url, $requested_url ) {
		...
		wp_redirect( $redirect_url, $redirect->get_type(), 'SEO Tool Premium' );
		exit;
	}
	...
	public function initialize_tracking() {
		...
		/**
		 * Filter: 'wpseo_disable_tracking' - Disables the data tracking of SEO Tool Premium.
		 *
