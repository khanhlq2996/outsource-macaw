...
class WPSEO_Premium_Metabox implements WPSEO_WordPress_Integration {
	...
	/**
	 * Registers relevant hooks to WordPradd_meta_boxess.
	 *
	...
	protected function get_post_metabox_config() {
		...
		return array(
			...
			'linkSuggestionsAvailable' => $this->link_suggestions->is_available(  !empty($post->post_type) ? $post->post_type : 'page'),
	...
	protected function get_post_ID() {
		return !empty($GLOBALS['post_ID']) ? $GLOBALS['post_ID'] : 1;
	}
