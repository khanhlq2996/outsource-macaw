	...
	public function get_field() {
		...
		if ( ! WPSEO_Utils::is_yoast_seo_premium() ) {
			$field->add_suggestion(
				/* translators: %s resolves to SEO Tool Premium */
				sprintf( __( 'Outrank the competition with %s', 'wordpress-seo' ), 'SEO Tool Premium' ),
				/* translators: %1$s resolves to SEO Tool Premium */
				sprintf( __( 'Do you want to outrank your competition? %1$s gives you awesome additional features that\'ll help you to set up your SEO strategy like a professional. Add synonyms and related keywords, use our Premium SEO analysis, the redirect manager and our internal linking tool. %1$s will also give you access to premium support.', 'wordpress-seo' ), 'SEO Tool Premium' ),
				array(
				...
				array(
					...
					'title' => sprintf(
						/* translators: %1$s expands to SEO Tool Premium. */
		...
		// When we are running in SEO Tool Premium and don't have Local SEO installed, show Local SEO as suggestion.
