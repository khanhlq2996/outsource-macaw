...
class WP_REST_Users_Controller extends WP_REST_Controller {
	...
	public function update_item( $request ) {
		...
		/** This action is documented in libs/rest-api/endpoints/class-wp-rest-users-controller.php */
	 ...
	 *
	 * Performs a couple of checks like edit_user() in acp/includes/user.php.
	 *
	 * @since 4.7.0
	 *
