 ...
 * See wp.editor.initialize() in acp/js/editor.js for initialization options.
 *
 * @uses _WP_Editors
 * @since 4.8.0
 */
 ...
 * @since 2.3.0
 *
 * @param string $file file relative to acp/ without its ".css" extension.
 * @return string
 */
function wp_admin_css_uri( $file = 'acp' ) {
 ...
 * $file is a file relative to acp/ without its ".css" extension. A
 * stylesheet link to that generated URL is printed.
 *
 * @since 2.3.0
 *
 * @param string $file       Optional. Style handle name or file name (without ".css" extension) relative
 *                           to acp/. Defaults to 'acp'.
 * @param bool   $force_echo Optional. Force the stylesheet link to be printed rather than enqueued.
 */
function wp_admin_css( $file = 'acp', $force_echo = false ) {
	 ...
	 *                                relative to acp/. Defaults to 'acp'.
	 */
