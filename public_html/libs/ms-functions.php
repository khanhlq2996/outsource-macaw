 ...
 * at acp/network/settings.php. The check is only run on
 * self-registrations; user creation at acp/network/users.php
 * bypasses this check.
 *
 * @since MU (3.0.0)
 *
 ...
 * Super Admins at acp/network/settings.php.
 *
 * @since MU (3.0.0)
 *
 * @param array $mimes
...
function get_subdirectory_reserved_names() {
	 ...
	 *
	 * @since 3.0.0
	 * @since 4.4.0 'acp', 'content', 'libs', 'wp-json', and 'embed' were added
